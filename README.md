...
In specific force fields like **CLAY-FF**, where interactions are predominantly non-bonded, automatically generated bonded terms may be physically redundant. The `--clean` function identifies and removes harmonic bonded parameters where force constants or equilibrium values are null.
